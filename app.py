...
def main():
    ...
    st.write("This dataset was originally contributed to the UCI Machine Learning repository nearly 30 years ago, mushroom hunting otherwise known as shrooming is enjoying new peaks in popularity.")
